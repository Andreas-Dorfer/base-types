...
$@"partial record {record.Identifier.Text} : System.IComparable<{baseTypes[0]}>
{{
    ...
    public int CompareTo({baseTypes[0]} other) => System.Collections.Generic.Comparer<{baseTypes[0]}>.Default.Compare(Value, other);
